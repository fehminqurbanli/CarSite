...
using CarSite.Core.DependencyResolvers;
using CarSite.Core.Extensions;
using CarSite.Core.Utilities.IoC;
...
namespace CarSiteMVC.UI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IValidator<TB_Ads>,Tb_Ads_Validator>();
